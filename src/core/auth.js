...
DM.provide('', {
  ...
  login: function(cb, opts) {
    ...
    var screenX = typeof window.screenX != 'undefined' ? window.screenX : window.screenLeft,
      ...
      outerHeight =
        typeof window.outerHeight != 'undefined' ? window.outerHeight : document.documentElement.clientHeight - 22, // 22 = IE toolbar height
      width = 500,
      height = 520,
